...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create greeting" do
    assert_difference('Greeting.count') do
      post greetings_url, params: { greeting: { messeage: @greeting.messeage, name: @greeting.name } }
    end
  ...
  test "should update greeting" do
    patch greeting_url(@greeting), params: { greeting: { messeage: @greeting.messeage, name: @greeting.name } }
